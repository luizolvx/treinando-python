# Meus Códigos de Estudo em Python
...
### [boas\_vindas.py](boas_vindas.py)
...
### [tipos\_de\_dados.py](tipos_de_dados.py)
...
### [analisador\_de\_string.py](analisador_de_string.py)
...
### [antecessor\_e\_sucessor.py](antecessor_e_sucessor.py)
...
### [aritmetica\_basica.py](aritmetica_basica.py)
...
### [calculadora\_de\_media.py](calculadora_de_media.py)
...
### [conversor\_de\_distancia.py](conversor_de_distancia.py)
...
### [gerador\_de\_tabuada.py](gerador_de_tabuada.py)
...
### [calculadora\_de\_desconto.py](calculadora_de_desconto.py)
...
### [calculadora\_de\_aumento\_salarial.py](calculadora_de_aumento_salarial.py)
...
### [conversor\_de\_temperatura.py](conversor_de_temperatura.py)
...
### [calculadora\_aluguel\_carro.py](calculadora_aluguel_carro.py)
...
### [porcao\_inteira.py](porcao_inteira.py)
...
### [teorema\_de\_pitagoras.py](teorema_de_pitagoras.py)
...
### [calculadora\_trigonometrica.py](calculadora_trigonometrica.py)
...
### [sorteador\_de\_alunos.py](sorteador_de_alunos.py)
...
### [sorteio\_de\_ordem.py](sorteio_de_ordem.py)
...
### [tocador\_de\_musica.py](tocador_de_musica.py)
...
### [manipulador\_de\_nomes.py](manipulador_de_nomes.py)
...
### [extrator\_de\_digitos.py](extrator_de_digitos.py)
...
### [verifica\_cidade.py](verifica_cidade.py)
...
### [verifica\_silva.py](verifica_silva.py)
...
### [analisador\_de\_letras.py](analisador_de_letras.py)
...
### [extrator\_de\_nomes.py](extrator_de_nomes.py)
...
### [jogo\_da\_adivinhacao.py](jogo_da_adivinhacao.py)
...
### [radar\_eletronico.py](radar_eletronico.py)
...
### [verificador\_par\_ou\_impar.py](verificador_par_ou_impar.py)
...
### [calculadora\_de\_viagem.py](calculadora_de_viagem.py)
...
### [verificador\_de\_ano\_bissexto.py](verificador_de_ano_bissexto.py)
...
### [encontrar\_o\_maior.py](encontrar_o_maior.py)
...
### [calculadora\_de\_reajuste\_salarial.py](calculadora_de_reajuste_salarial.py)
...
### [analisador\_de\_triangulos.py](analisador_de_triangulos.py)
...
### [verificador\_emprestimo.py](verificador_emprestimo.py)
...
### [conversor\_de\_bases\_numericas.py](conversor_de_bases_numericas.py)
...
### [comparador\_de\_numeros\_simples.py](comparador_de_numeros_simples.py)
...
### [verificador\_alistamento\_militar.py](verificador_alistamento_militar.py)
...
### [avaliador\_de\_notas.py](avaliador_de_notas.py)
...
### [classificador\_de\_idade.py](classificador_de_idade.py)
...
### [classificador\_de\_triangulos.py](classificador_de_triangulos.py)
...
### [calculadora\_de\_imc.py](calculadora_de_imc.py)
...
### [calculadora\_de\_pagamento.py](calculadora_de_pagamento.py)
...
### [caixa\_eletronico.py](caixa_eletronico.py)
...
### [contagem\_regressiva.py](contagem_regressiva.py)
...
### [gerador\_pa.py](gerador_pa.py)

  - **Descrição:** Gera os **10 primeiros termos** de uma **Progressão Aritmética (PA)** com base no primeiro termo e na razão fornecidos pelo usuário.
  - **Conceitos:** Laços de repetição (`for`) e operadores aritméticos.

### [soma\_numeros\_impares.py](soma_numeros_impares.py)
...
### [tabuada\_usando\_for.py](tabuada_usando_for.py)
...
### [soma\_seis\_numeros\_pares.py](soma_seis_numeros_pares.py)
...
### [masculino\_feminino.py](masculino_feminino.py)
...
### [numero\_primo.py](numero_primo.py)
...
### [jogo\_sorteio.py](jogo_sorteio.py)
...
### [menu\_matematico.py](menu_matematico.py)
...
### [fatorial\_while.py](fatorial.py)
...
### [pa\_while2.0.py](pa_while2.0.py)
...
### [sequencia\_fibonacci.py](sequencia_fibonacci.py)
...
### [somador\_magico.py](somador_magico.py)
...
### [analise\_valores.py](analise_valores.py)
...
### [acumulador\_numeros.py](acumulador_numeros.py)
...
### [tabuada\_infinita.py](tabuada_infinita.py)
...
### [contador\_perfil\_demografico.py](contador_perfil_demografico.py)
